...
export default function HomeScreen() {
  ...
  const [isCurrentQuarterCompleted, setIsCurrentQuarterCompleted] = useState(false); // 🆕 simulate state from dashboard
          ...
          >
            <View style={styles.cardRow}>
              ...
              >
                ...
                <Text style={styles.cardSubtitle}>View your payment records</Text>
              </TouchableOpacity>

              <TouchableOpacity style={[styles.dashboardCard, styles.card2]}>
                <MaterialIcons name="play-circle-outline" size={32} color="#1F245E" />
            ...
            <View style={styles.quickActionsContainer}>
              ...
              <View style={styles.quickActionsRow}>
                <TouchableOpacity style={styles.quickActionButton}>
                  <MaterialIcons name="account-balance" size={24} color="#1F245E" />
                ...
                >
                  <MaterialIcons name="contact-support" size={24} color="#1F245E" />
